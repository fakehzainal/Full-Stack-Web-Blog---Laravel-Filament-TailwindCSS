...
@section('content')
    <section class="py-16">
        <div class="layout-container">
            <p class="text-sm font-bold mb-2">Berita</p>
            <h1 class="text-3xl font-bold mb-4">Semua artikel terbaru</h1>
            <p class="text-text-muted-light dark:text-text-muted-dark mb-10">
                Temukan insight terbaru seputar produk, desain, dan pertumbuhan startup.
            </p>
